//Q.5. Write java program to accept directory name from user and write data of all files along with its name & size of each file into one newly created file named as "Marvellous.txt"
